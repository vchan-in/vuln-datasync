...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_aliases 
    ON vulnerabilities USING GIN(aliases);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_ecosystem 
    ON vulnerabilities(ecosystem);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_package_name 
    ON vulnerabilities(package_name);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_data_hash 
    ON vulnerabilities(data_hash);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_source 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_modified_at 
    ON vulnerabilities(modified_at);

-- Index for ecosystem + package queries
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vulnerabilities_ecosystem_package 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_jobs_state_queue 
    ON jobs(state, queue);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_processing_stats_source_start_time 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_exports_version 
    ON exports(version);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_exports_created_at 
